...
export default function Navbar() {
  ...
  return (
    <div className="w-full flex justify-center pt-4 px-4 fixed top-0 z-50">
      <div 
        className={`w-full max-w-7xl border-2 border-gray-200 bg-white flex items-center py-4 px-6 ${
  ...
  <Link href="/" className="flex items-center">
    <span className="font-mono font-black text-xl tracking-tight uppercase">STACK<span className="text-[#00d447]">IT</span></span>
      ...
      {mobileSearchOpen && (
        <div className="md:hidden fixed top-[72px] left-4 right-4 p-3 bg-white border-2 border-gray-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] z-40">
          <SearchBar />
        </div>
      )}
