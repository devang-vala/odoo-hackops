...
export default function Navbar() {
  ...
  return (
    <div className="w-full flex justify-center pt-4 px-4 fixed top-0 z-50">
      <div 
        className={`w-full max-w-7xl border-2 border-gray-600 bg-white flex items-center py-4 px-6 ${
          scrolled ? 'shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)]' : ''
        }`}
      >
        {/* Mobile Menu Button */}
        ...
        <div className="flex-1 flex justify-center">
          <Link href="/" className="flex items-center">
            <span className="text-xl font-bold tracking-tight">StackIt</span>
          </Link>
        </div>

        {/* Authentication - Right aligned */}
            ...
            <div className="flex items-center space-x-3">
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <div className="w-8 h-8 border-2 border-gray-200 bg-gray-100 flex items-center justify-center text-gray-800 cursor-pointer hover:translate-y-[-2px] hover:translate-x-[-2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.1)] transition-all">
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-[72px] left-4 right-4 bg-white border-2 border-gray-200 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.1)] z-50">
